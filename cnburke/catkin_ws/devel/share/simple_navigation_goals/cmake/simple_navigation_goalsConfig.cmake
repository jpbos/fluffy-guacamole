...
if("TRUE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/cameron/repos/fluffy-guacamole/cnburke/catkin_ws/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /home/cameron/repos/fluffy-guacamole/cnburke/catkin_ws/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /home/cameron/repos/fluffy-guacamole/cnburke/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'cameron <cameron@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cameron/repos/fluffy-guacamole/cnburke/catkin_ws/src/simple_navigation_goals/${idir}'.  Ask the maintainer 'cameron <cameron@todo.todo>' to fix it.")
    endif()
