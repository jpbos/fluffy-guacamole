...
if("TRUE" STREQUAL "TRUE")
  set(statistics_msgs_SOURCE_PREFIX /home/cameron/repos/fluffy-guacamole/cnburke/jackal_navigation/src/pointgrey_camera_driver/statistics_msgs)
  set(statistics_msgs_DEVEL_PREFIX /home/cameron/repos/fluffy-guacamole/cnburke/jackal_navigation/devel)
  ...
  set(statistics_msgs_INSTALL_PREFIX /home/cameron/repos/fluffy-guacamole/cnburke/jackal_navigation/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'statistics_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'statistics_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cameron/repos/fluffy-guacamole/cnburke/jackal_navigation/src/pointgrey_camera_driver/statistics_msgs/${idir}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
    endif()
...
set(statistics_msgs_EXPORTED_TARGETS "statistics_msgs_generate_messages_cpp;statistics_msgs_generate_messages_lisp;statistics_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${statistics_msgs_dep}_FOUND)
      find_package(${statistics_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${statistics_msgs_dep} REQUIRED ${depend_list})
  endif()
